...
class Ui_Graph_Calculator(object):
    def setupUi(self, Graph_Calculator):
        ...
        self.horizontalLayoutWidget.setGeometry(QtCore.QRect(759, 499, 161, 51))

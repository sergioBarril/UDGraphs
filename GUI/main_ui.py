...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.lb_main.setGeometry(QtCore.QRect(40, 30, 660, 51))
        font = QtGui.QFont()
        ...
        self.G_options.setGeometry(QtCore.QRect(90, 270, 461, 201))
        ...
        self.G_layout.addWidget(self.randomName, 0, 2, 1, 2)
        self.sat_color = QtWidgets.QCheckBox(self.G_options)
        self.sat_color.setChecked(True)
        self.sat_color.setObjectName("sat_color")
        self.G_layout.addWidget(self.sat_color, 4, 2, 1, 2)
        self.dimacs = QtWidgets.QCheckBox(self.G_options)
        self.dimacs.setObjectName("dimacs")
        self.G_layout.addWidget(self.dimacs, 5, 1, 1, 1)
        self.cnf = QtWidgets.QCheckBox(self.G_options)
        self.cnf.setObjectName("cnf")
        self.G_layout.addWidget(self.cnf, 5, 2, 1, 1)
        self.lb_G = QtWidgets.QLabel(self.centralwidget)
        self.lb_G.setGeometry(QtCore.QRect(40, 100, 660, 81))
        font = QtGui.QFont()
        font.setFamily("Euphemia")
        ...
        self.graphData.setGeometry(QtCore.QRect(500, 210, 200, 68))
        ...
        self.btn_M_property.setGeometry(QtCore.QRect(580, 410, 120, 50))
        self.btn_M_property.setObjectName("btn_M_property")
        self.btn_clear = QtWidgets.QPushButton(self.centralwidget)
        self.btn_clear.setGeometry(QtCore.QRect(580, 290, 120, 50))
        self.btn_clear.setObjectName("btn_clear")
        self.btn_cnf_trim = QtWidgets.QPushButton(self.centralwidget)
        self.btn_cnf_trim.setGeometry(QtCore.QRect(580, 350, 120, 50))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.cnf.setText(_translate("MainWindow", "CNF"))
